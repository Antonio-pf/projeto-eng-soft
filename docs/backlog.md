...
| 11 | Como Administrador, quero cadastrar um item vinculado a uma categoria e com unidade de medida, para que o estoque reflita os tipos reais de doação recebidos. | - Formulário solicita nome (obrigatório), categoria (obrigatório), unidade de medida (obrigatório) e estoque mínimo (obrigatório, inteiro ≥ 0)<br>- Item salvo aparece na lista com saldo zero | Deve ter | 3 | 1 |
